...
In early 2025, I saw a [Reddit post](https://www.reddit.com/r/transit/comments/1hz8gu4/i_started_making_a_game_where_you_build_a_subway/) showcasing a new transit-focused game called [Subway Builder](https://www.subwaybuilder.com/). I played a lot of Cities: Skylines (both [one](https://store.steampowered.com/app/255710/Cities_Skylines/) & [two](https://store.steampowered.com/app/949230/Cities_Skylines_II/)), [OpenTTD](https://www.openttd.org/), and a little bit of [NIMBY Rails](https://store.steampowered.com/app/1134710/NIMBY_Rails/). So I was excited to try out this new game. While the price is a little steep ($30 from the website), I spent my adult money and bought the game last December.

![NYC save with 600+ stations](https://jeongwoo.xyz/blog/subway-builder/nyc.jpg)
My NYC save with 600+ stations. Unfortunately, it's too laggy to continue.

## The game basics

In normal mode, you start with $3 billion and tasked with creating a rail transit network for your city. The game supports 34 cities and many more with mods. In terms of mode of transit, you can build heavy metro, light metro, and commuter rail. Each type of train has different characteristics such as speed, acceleration, turning radius, capacity, cost, and many more.

![Subway Builder heavy metro train stats](https://jeongwoo.xyz/blog/subway-builder/heavy-metro-train-type-stats.png)
Train stats for heavy metro.

One quirk of Subway Builders is the building cost attempts to be similar to real life construction costs. While the game does not match today's absurdly inflated transit project budgets, it does a decent job. When you demolish a building, there is a cost determined by building foundation depth and size. Additionally, the cost of construction varies by the type of construction such as elevated, at grade, cut and cover, or deep bore. There is even an additional cost multiplier for building under bodies of water.

![Subway Builder building UI and construction costs](https://jeongwoo.xyz/blog/subway-builder/building-ui.jpg)
Building in Subway Builder
...
![Seattle transit demand bubbles](https://jeongwoo.xyz/blog/subway-builder/seattle-transit-demand.jpg)
Worker demand bubbles in Seattle where larger bubbles have more demand.

## My first subway

Since I went to school in Austin, I decided to build Austin's [Project Connect plan](https://www.atptx.org/current-map/). I started with the orange and blue lines, with the airport expansion in blueprint mode. My starting line costed a cool $1 billion, while the real life plan is projected to cost $7.1 billion...

![Austin Project Connect starting network](https://jeongwoo.xyz/blog/subway-builder/austin-starting-network.jpg)
Building the Orange and Blue line, with the phase 2 airport extension shown in the bottom right.
...
![Austin dream transit network](https://jeongwoo.xyz/blog/subway-builder/austin-dream-transit-network.png)
Latest version of my Austin transit network.

## Exploring NYC, Seoul, and more
