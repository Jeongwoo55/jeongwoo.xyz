...
Additionally, I may consider using [Proxmox](https://www.proxmox.com/en/) to create VMs for each set of tasks. One VM could be used for my Docker applications, another for Minecraft or game servers, and the last one could be for personal development projects.
